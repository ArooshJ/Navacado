"""
Django settings for Navacado project.
...
from datetime import timedelta # manuall added
...
SECRET_KEY = 'django-insecure-2d-%f1kaw24t2%2_7)sv*8^@pr1n!57f#-&z=6pd%dggga*hzd'
...
INSTALLED_APPS = [
    ...
    'ams.apps.AmsConfig', # Configure self-created app 
    'rest_framework', # adding rest framework
    'corsheaders', # to allow cross-origin requests cors
...
# need to be added manually for jwt auth
REST_FRAMEWORK = {
...
WSGI_APPLICATION = 'Navacado.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'ENGINE': 'django.db.backends.mysql',  # configuring mysql
        'NAME': 'Navacado',  #mySQL database name
        'USER': 'root', 
        'PASSWORD': 'aj19@SQL',
